...
def sign_in(Email, Password):
    ...
    if (menusor_hossz == 3): # sikertelen belépés
        ...
        user_name_btn = user_prof_btns[-2].text
        print(f'ez a szöveg {user_name_btn}')
        ...
        find_user_btn = WebDriverWait(browser, 5).until(EC.presence_of_element_located((By.XPATH, f'//li[@ class ="nav-item"]//a[@ href="#/@{user_name_btn}/"]')))
        find_user_btn.click()
        time.sleep(2)
        find_user_btn.click()
        # find_log_out_btn = WebDriverWait(browser, 5).until(EC.presence_of_element_located((By.XPATH, '//i[@class="ion-android-exit"]')))
